...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	<noscript>
		<div
			...
			<img src="<%=ConstUtil.SERVER_RESOURCES%>/images/noscript.gif"
				alt='抱歉，请开启脚本支持！' />
		</div>
	</noscript>
	<div region="north" split="true" border="false"
		style="overflow: hidden; height: 30px;
        background: url(<%=ConstUtil.SERVER_RESOURCES%>/images/layout-browser-hd-bg.gif) #7f99be repeat-x center 50%;
        line-height: 20px;color: #fff; font-family: Verdana, 微软雅黑,黑体">
		<span style="float: right; padding-right: 20px;" class="head">欢迎
			${loginUser.nickname } <a href="#" id="editpass">修改密码</a> <a
